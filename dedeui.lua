...
local library = {
    ...
    folders = {
        main = "disarray",
        assets = "disarray/assets",
        configs = "disarray/configs"
    },
    shared = {
        initialized = false,
        fps = 0,
...
local sections = {}
local theme = {
    accent = Color3.fromRGB(55, 175, 225),--55, 175, 225
    lightcontrast = Color3.fromRGB(30,30,30),--30,30,30
    darkcontrast = Color3.fromRGB(25,25,25),--25,25,25
        ...
        function window:Watermark(info)
            ...
            utility:Connection(rs.RenderStepped, function(FPS)
                ...
                if (tick() - Tick) > 0.15 then
                    watermark_title.Text = string.format("disarray | Ping : %s | Fps : %u", library.shared.ping, library.shared.fps)
                    window.watermark:UpdateSize()
                    --
                    Tick = tick()
                end
