-- // Tables
local Library = loadstring(game:HttpGet("https://github.com/ruini1/Ui/raw/main/splixprivate/SplixPrivate.lua"))() -- Could Also Save It In Your Workspace And Do loadfile("Library.lua")()
-- // Variables
-- // Init
